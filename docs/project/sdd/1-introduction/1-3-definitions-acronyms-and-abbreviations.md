...
| **Master's Requirements**                  | Specific exams/ECTS a student must complete to be eligible for a particular Master's degree (e.g., specific bachelor specializations, minimum grade, ECTS threshold). OhMyUniversity displays these requirements for student consultation. |
